...
| IMP-11 | [improvements-11-supabase-integration.md](./improvements-11-supabase-integration.md) | Backend / Auth | Integración con Supabase: autenticación, BD en la nube y sincronización real-time offline-first |
