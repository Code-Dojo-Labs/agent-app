...
export declare const DEFAULT_COLUMNS: Omit<Column, 'id' | 'boardId'>[];
...
export declare const DEFAULT_BOARD_NAME = "Mi tablero";
...
export declare const DEFAULT_PROJECT_NAME = "General";
/** Prefijo del proyecto por defecto. */
export declare const DEFAULT_PROJECT_PREFIX = "GEN";
...
export declare const DEFAULT_LABELS: Omit<Label, 'id'>[];
/** Tipos de evento registrados en el historial de actividad. */
export type ActivityEventType = 'created' | 'status_change' | 'priority_change' | 'label_added' | 'label_removed';
