...
export function openDatabase() {
    ...
    if (_openPromise)
        return _openPromise; // todas las llamadas concurrentes esperan la misma promesa
    ...
    if (!('indexedDB' in globalThis) || !globalThis.indexedDB) {
        return Promise.reject(new Error('IndexedDB no está disponible en este contexto. Por favor, sal del modo privado o usa otro navegador.'));
    }
 ...
 */
export function idbTransaction(tx) {
    return new Promise((resolve, reject) => {
