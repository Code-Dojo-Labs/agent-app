 ...
 */
import { getThemePreference, setThemePreference, resolveEffectiveTheme, } from '../../../utils/theme.js';
const OPTIONS = [
...
export class DojoThemeToggle extends HTMLElement {
    ...
    _onSelect(preference) {
        ...
        this.dispatchEvent(new CustomEvent('dojo:theme-changed', {
            bubbles: true,
            composed: true,
            detail: {
                preference,
