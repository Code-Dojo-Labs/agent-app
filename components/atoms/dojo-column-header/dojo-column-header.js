...
export class DojoColumnHeader extends HTMLElement {
    ...
    get _columnName() { return this.getAttribute('column-name') ?? ''; }
    get _count() { return Number(this.getAttribute('count') ?? 0); }
    get _totalCount() {
    ...
    `;
        ...
        badge.setAttribute('aria-label', hasFilter
