    ...
    _buildLabelRow(label) {
        ...
        if (this._editingId === label.id) {
            ...
            deleteBtn.addEventListener('click', async () => {
                ...
                this._buildContent();
                requestAnimationFrame(() => {
                    this._shadow.querySelector('.delete-btn-cancel')?.focus();
                });
            });
