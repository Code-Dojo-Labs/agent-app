...
import { getAllProjects, createProject, updateProject, deleteProject, isValidPrefix, } from '../../../db/project.repository.js';
export class DojoProjectManager extends HTMLElement {
    static TAG = 'dojo-project-manager';
    ...
    async show() {
        ...
        requestAnimationFrame(() => {
            this._shadow.querySelector('.panel-close')?.focus();
        });
    }
    hide() {
    ...
    _buildContent() {
        ...
        if (this._creating) {
            ...
            createBtn.addEventListener('click', () => {
                ...
                this._buildContent();
                requestAnimationFrame(() => {
                    this._shadow.querySelector('.create-name-input')?.focus();
                });
            });
    ...
    _buildProjectRow(project) {
        ...
        if (this._editingId === project.id) {
            ...
            editBtn.addEventListener('click', () => {
                ...
                this._buildContent();
                requestAnimationFrame(() => {
                    this._shadow.querySelector('.edit-name-input')?.focus();
                });
            });
            ...
            if (isDefault) {
                ...
                deleteBtn.addEventListener('click', () => {
                    ...
                    this._buildContent();
                    requestAnimationFrame(() => {
                        this._shadow.querySelector('.btn-secondary')?.focus();
                    });
                });
            }
